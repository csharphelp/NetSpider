...
namespace Sop.Spider.Common
{
	...
	public static class ExcelExtensions
	{
		...
		public static void EmailTo(this IDbConnection conn, string sql, string fileName, string subject, string emailTo, string emailHost, int port, string account, string password, string displayName = "Sop.Spider Alert")
		{
		...
		/// <param name="password">邮件发送服务的密码</param>
		/// <param name="displayName">邮件发送服务的显示名称</param>
		public static void EmailTo(this IDbConnection conn, string sql, string fileName, string subject, IEnumerable<string> emailTo, string emailHost, int port, string account, string password, string displayName = "Sop.Spider Alert")
		{
		...
		/// <param name="password">邮件发送服务的密码</param>
		/// <param name="displayName">邮件发送服务的显示名称</param>
		public static void EmailTo(string file, string subject, IEnumerable<string> emailTo, string emailHost, int port, string account, string password, string displayName = "Sop.Spider Alert")
		{
