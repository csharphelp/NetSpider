...
{
	public class DatabaseSpider : Sop.Spider.Spider
	{
		...
		public DatabaseSpider(IEventBus mq, IStatisticsService statisticsService, SpiderOptions options, ILogger<Sop.Spider.Spider> logger, IServiceProvider services) : base(mq, statisticsService, options, logger, services)
		{
		}
	}
}